...
import com.example.Resume_Builder.service.EmailService;
...
public class EmailController {
    ...
    public ResponseEntity<Map<String, Object>> sendResumeByEmail(
        ...
        emailService.sendEmailWithAttachment(recipientEmail, emailSubject, emailBody, pdfFileBytes, filename);
